...
public class NewSimpleCharacterController : MonoBehaviour
{
    ...
    {
        MoveCharacter();
        //moved velocity application up here
    ...
    private void ApplyGravity()
    {
        ...
        // Apply velocity old... uneeded. This down here was causing velocity to be applied twice which is why jump was multiplied
        //controller.Move(velocity * Time.deltaTime);
    }
